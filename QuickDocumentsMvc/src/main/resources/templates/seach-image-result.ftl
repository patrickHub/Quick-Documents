                    ...
                    <div class="jcarousel" data-jcarousel="true">
                        <ul>
                            <#list searchImages as foundImage>
                                ...
                                <li><a href="${url.homeUrl}/${files}/${foundImage.imgPath}" data-lity data-lity-desc="Photo of a search"><img src="${url.homeUrl}/${files}/${foundImage.imgPath}" alt="${foundImage.imgPath}"></a></li>
